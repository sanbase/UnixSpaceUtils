 ...
 * Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.
	...
	Last modification:Fri Mar 23 14:14:59 2001
			Module:More.c
*/
#include <fcntl.h>
#include <sys/stat.h>
...
char **argv;
{
	...
	struct stat st;
	char *help="PageUp -page PageDown +page Up -line Down +line F10 exit ";
	if(argc<2)
	{
...
/*        dpo(es); */
	...
	switch(Xmouse(dpi()))
	{
		...
		case '/':
		{
			...
			bzero(obr,254);
			dpedit(0,obr,255,l_x-1,0,l_y-1,0);
...
static char *Keys[]=
{
       ...
       "Ins",  "",    "PageDown",    "PageUp", "F8",  "F9",    "F10",  "F11"
};
